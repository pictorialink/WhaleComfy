...
try:
    ...
    pass
if not hasattr(args, 'supports_fp8_compute'):
    args.supports_fp8_compute = False
...
def unet_dtype(device=None, model_params=0, **kwargs):
...
def should_use_fp16(prioritize_performance=False,device=None, model_params=0):
    return False
